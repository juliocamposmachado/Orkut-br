...
-- Se a tabela não existir, criar ela com base na migração
-- (Execute apenas se o resultado acima for false)
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    -- Políticas RLS para photos_feed
...
SELECT 'Execute este script no Supabase SQL Editor para verificar e corrigir a tabela photos_feed' AS instrucao;
