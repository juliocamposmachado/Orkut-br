    ...
    try {
      ...
      const response = await fetch('/api/communities', {
        ...
        body: JSON.stringify({
          ...
          welcome_message: formData.welcome_message.trim() || `Bem-vindo à comunidade ${formData.name.trim()}!`,
      ...
      if (!response.ok) {
        throw new Error(result.error || result.message || 'Erro ao criar comunidade')
      }

      if (result.demo) {
        toast.warning('⚠️ Modo demonstração: A comunidade não foi salva no banco de dados')
      } else {
      ...
      toast.error(error instanceof Error ? error.message : 'Erro ao criar comunidade. Tente novamente.')
    } finally {
      setLoading(false)
    }
  }
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
            ...
            {/* Limite de Membros */}
            <div>
              <Label htmlFor="max_members" className="text-sm font-medium text-gray-700">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Mensagem que novos membros receberão..."
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => setFormData(prev => ({ ...prev, allow_member_invites: checked as boolean }))}
                />
                <Label htmlFor="allow_member_invites" className="text-sm text-gray-700">
                  Permitir que membros enviem convites
                </Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => setFormData(prev => ({ ...prev, auto_approve_posts: checked as boolean }))}
                />
                <Label htmlFor="auto_approve_posts" className="text-sm text-gray-700">
